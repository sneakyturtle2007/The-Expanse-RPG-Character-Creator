        ...
        if(str(image) != "noimage.jpg" and str(image) != "photo1.jpg" and str(image) != "Belter.jpg" and str(image) != "TheExpanse-Earther.jpg" and str(image) != "Martian.jpg" and str(image) != "Character_Sheet_1.jpg" and str(image) != "Character_Sheet_2.jpg"):
            ...
            with open("Characters.txt") as characters_text:
                ...
                for value in Character:
                    ...
                    index1 += 1
                temp_character = character(Character[0],Character[1],Character[2],Character[3],Character[4],int(Character[5]),int(Character[6]),int(Character[7]),int(Character[8]),int(Character[9]),int(Character[10]),int(Character[11]),int(Character[12]),int(Character[13]),Character[14],Character[15],Character[16])
...
def save_displayed_character(stats):
            ...
            if index1 > 3 and index1 < 13:
                for range_and_score in ability_score_table:
                    if(int(value) == range_and_score[1]):
                        ...
                        print(range_and_score[0][0])
                        current_character_stats[index1] = range_and_score[0][0]
            else:
                current_character_stats[index1] = value
            
            index1 += 1

    Characters_text_file= open("Characters.txt", "w")
    index1 = 0
    for characters in Existing_characters:
        if(characters.name == stats.name):
            print("debug3")
            
            Existing_characters[index1] = character(current_character_stats[0],current_character_stats[13],current_character_stats[14],current_character_stats[15],current_character_stats[16],convert_to_die_roll(int(current_character_stats[4])),convert_to_die_roll(int(current_character_stats[5])),convert_to_die_roll(int(current_character_stats[6])),convert_to_die_roll(int(current_character_stats[7])),convert_to_die_roll(int(current_character_stats[8])),convert_to_die_roll(int(current_character_stats[9])),convert_to_die_roll(int(current_character_stats[10])),convert_to_die_roll(int(current_character_stats[11])),convert_to_die_roll(int(current_character_stats[12])), current_character_stats[1], current_character_stats[3], current_character_stats[2])
    ...
    display_character_ClickedOn("False", character(current_character_stats[0],current_character_stats[13],current_character_stats[14],current_character_stats[15],current_character_stats[16],convert_to_die_roll(int(current_character_stats[4])),convert_to_die_roll(int(current_character_stats[5])),convert_to_die_roll(int(current_character_stats[6])),convert_to_die_roll(int(current_character_stats[7])),convert_to_die_roll(int(current_character_stats[8])),convert_to_die_roll(int(current_character_stats[9])),convert_to_die_roll(int(current_character_stats[10])),convert_to_die_roll(int(current_character_stats[11])),convert_to_die_roll(int(current_character_stats[12])), current_character_stats[1], current_character_stats[2], current_character_stats[3]))
