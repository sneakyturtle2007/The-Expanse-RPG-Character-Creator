...
def get_characters():
    ...
    for image in os.listdir("images\\"):
        if(str(image) != "noimage.jpg" and str(image) != "photo1.jpg" and str(image) != "Belter.jpg" and str(image) != "TheExpanse-Earther.jpg" and str(image) != "Martian.jpg" and str(image) != "Character_Sheet_1.jpg"):
            current_character = []
...
def display_stats(stats):
    global window_elements
    print(stats)
    stat_locations = [(60,70),(65,103),(93,137),(92,165),(260,280),(260,327),(260,373),(260,421),(260,467),(260,514),(260,561),(260,608),(260,655)]
    stat_values = [stats.name,stats.origin,stats.background,stats.social_class,stats.accuracy,stats.communication,stats.constitution,stats.dexterity,stats.fighting,stats.intelligence,stats.perception,stats.strength,stats.willpower]
    index = 0
